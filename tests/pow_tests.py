...
class TestClass:
    ...
    def test_server(self):
        ...
        import medium.server
        import requests
        import medium.config as cfg
        import time
        p = Process(target=medium.server.main)
        p.start()
    ...
    def test_sql_generate_model(self):
        ...
        import uuid
        import os.path
        ret = gm.generate_model(MODELNAME, "sql", appname="pow")
    ...
    def test_sql_model_type(self):
        ...
        from medium.models.sql.pow_test_model import PowTestModel
        m = PowTestModel()
    ...
    def test_sql_dbsetup(self):
        ...
        import medium.init_sqldb_environment
        import os
        os.chdir("..")
        r = medium.init_sqldb_environment.init_migrations()
        assert r == True
    ...
    def test_sql_migration(self):
        ...
        import medium.generate_migration
        import os
        os.chdir("..")
        script = medium.generate_migration.generate_migration(message="pow_test")
    ...
    def test_sql_dbupdate(self):
        ...
        import medium.update_db
        import os, time
        ret = None
        os.chdir("..")
        time.sleep(1)
        try:
            ret = medium.update_db.migrate("up")
    ...
    def test_tinydb_generate_model(self):
        ...
        import uuid
        import os.path
        ret = gm.generate_model(MODELNAME, "tinydb", appname="pow")
        # generate model returns true in case of success
        assert ret is True
    ...
    def test_tinydb_model_type(self):
        ...
        from medium.models.tinydb.pow_test_model import PowTestModel
        m = PowTestModel()
        assert isinstance(m, PowTestModel)

...
from medium.powlib import get_class_name
from medium.config import myapp
from medium.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('medium.models.sql.' + m)
